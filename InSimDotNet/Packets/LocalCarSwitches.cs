...
namespace InSimDotNet.Packets
{
    ...
    public static class LocalCarSwitches
    {
        ...
        ///     Turn signals off
        /// </summary>
        [Obsolete("Should now use SMALL_LCL")] public const int LCS_SIGNALS_OFF = LCS_SET_SIGNALS;

        /// <summary>
        ///     Turn signal left
        /// </summary>
        [Obsolete("Should now use SMALL_LCL")] public const int LCS_SIGNALS_LEFT = (1 << 8) | LCS_SET_SIGNALS;

        /// <summary>
        ///     Turn signal right
        /// </summary>
        [Obsolete("Should now use SMALL_LCL")] public const int LCS_SIGNALS_RIGHT = (2 << 8) | LCS_SET_SIGNALS;

        /// <summary>
        ///     Turn signal hazard
        /// </summary>
        [Obsolete("Should now use SMALL_LCL")] public const int LCS_SIGNALS_HAZARD = (3 << 8) | LCS_SET_SIGNALS;
        ...
        ///     Headlights off
        /// </summary>
        [Obsolete("Should now use SMALL_LCL")] public const int LCS_HEADLIGHTS_OFF = LCS_SET_HEADLIGHTS;

        /// <summary>
        ///     Headlights on
        /// </summary>
        [Obsolete("Should now use SMALL_LCL")] public const int LCS_HEADLIGHTS_ON = (1 << 11) | LCS_SET_HEADLIGHTS;
