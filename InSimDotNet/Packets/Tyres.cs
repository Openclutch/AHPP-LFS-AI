namespace InSimDotNet.Packets
{
    ...
    public struct Tyres
    {
        ...
        /// </summary>
        public TyreCompound FrontLeft { get; }

        /// <summary>
        ///     Gets the front-right tyre.
        /// </summary>
        public TyreCompound FrontRight { get; }

        /// <summary>
        ///     Gets the rear-left tyre.
        /// </summary>
        public TyreCompound RearLeft { get; }

        /// <summary>
        ///     Gets the rear-right tyre.
        /// </summary>
        public TyreCompound RearRight { get; }
        ...
        {
            if (obj is Tyres) return Equals((Tyres)obj);
            return false;
        }
