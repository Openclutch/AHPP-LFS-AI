...
namespace InSimDotNet
{
    ...
    public static class PacketFactory
    {
        ...
        public static PacketType GetPacketType(byte[] buffer)
        {
            ...
            if (buffer.Length > 1) return (PacketType)buffer[1];
        ...
        public static IPacket BuildPacket(byte[] buffer)
        {
            ...
            var packetType = GetPacketType(buffer);
            switch (packetType)
            {
        ...
        public static PacketType PacketLookup(string type)
        {
            ...
            if (Enum.TryParse(type, true, out packetType)) return packetType;
